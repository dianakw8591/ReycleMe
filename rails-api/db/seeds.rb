...
Item.create(name: "butter wrapper", general_type: "trash")
Item.create(name: "CD case", general_type: "trash")
Item.create(name: "aluminum foil", general_type: "trash")
Item.create(name: "batteries", general_type: "trash")
Item.create(name: "light bulbs", general_type: "trash")
Item.create(name: "paper towels", general_type: "trash")
Item.create(name: "styrofoam", general_type: "trash")
Item.create(name: "diapers", general_type: "trash")
